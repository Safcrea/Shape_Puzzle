...
<!-- Funplay Unity MCP project skill versions: unity-mcp-workflow@1.0.1 -->
...
- `funplay-unity-mcp-workflow` v1.0.1 - Efficient workflow for using Unity MCP to edit, import, compile, inspect, and test Unity projects.
...
- Project root: `D:\ProjectsUnity\Shape_Block_Puzzle\ShapePuzzle`
- Product name: `ShapePuzzle`
